...
namespace Crazysoft.OTR_Remote.ListViewEx
{
	/// <summary>
	...
	public class ListViewEx	: System.Windows.Forms.ListView
	{
		...
		{
            // Only call Win32 function when running on Windows
            ...
            else
            {
                ...
                // Principally, this array is always valid, because column order doesn't change
                return new int[] {0, 1};
            }
		}
        ...
        public void StartEditing(Control c, ListViewItem Item, int SubItem)
		{
		    ...
		    if (_editingControl.Tag != null && _editingControl.Tag.ToString() == "ComboBox")
		    {
		        ComboBox cb = (ComboBox)_editingControl;
		        cb.SelectedIndexChanged += new EventHandler(_editControl_Leave);
		        _editingControl = cb;
		    }
