...
"F:\Programmierung\AppUpdate\Crazysoft AppUpdate Builder\bin\Release\7za.exe" a -ttar -r "F:\Programmierung\PiKaSoft OTR Remote\Setup\Output\cotrremote.tar" "F:\Programmierung\PiKaSoft OTR Remote\TVBrowserPlugin\bin\OTRRemote.jar"
