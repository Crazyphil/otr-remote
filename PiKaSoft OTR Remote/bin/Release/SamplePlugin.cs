 ...
 * Copyright (C) Crazysoft 2006-2008
 * 
 * This sample shows how to develop a plugin for OTR Remote
 * easily and how to make correct usage of the Plugin Interface.
 * 
 ...
 * 
 * v1.0.0.1
 * CHANGE: Fixed some pieces of code in accordance to the Microsoft
 *         Code Analysis Tool
 * 
 * v1.0.0.0
 * Initial Release
...
public class Sample : IPlugin
{
    ...
    public void Initialize()
    {
        ...
        settings.Add("Destination Folder", myDocuments, Crazysoft.OTRRemote.ValueType.String);

        // Add the output filename to the collection
        settings.Add("Destination Filename", "OTRRemote.bat", Crazysoft.OTRRemote.ValueType.String);
    }
    ...
    public object SaveRecordingScript()
    {
        ...
        if (String.IsNullOrEmpty(settings["Destination Folder"].Value))
        {
        ...
        if (di.Exists)
        {
            ...
            if (String.IsNullOrEmpty(settings["Destination Filename"].Value))
            {
